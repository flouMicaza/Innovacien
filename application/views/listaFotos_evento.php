...
if ($tipo!='adiministrador'){
	echo ' 
		<form class="form-horizontal" method = "post" action="'.base_url().'eventos2Controller/verAsistencia" enctype = "multipart/form-data">

		<!-- Button -->
    	<div class="form-group">
      		<label class="col-md-4 control-label" for="singlebutton"></label>
      		<div class="col-md-4">
        		<button type ="submit" id="singlebutton" name="singlebutton" class="botones">Siguiente</button>
      		</div>
   		</div>
   		</form>
